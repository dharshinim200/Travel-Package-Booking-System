...
class UserAndRoleManagementApplicationTests {
	...
	@Test
	public void getUserSuccessTest() throws UserNotFound {
		int userId = 113;
...
//	@Test
//	public void getPackNotFoundTest() {
//	    int userId = 99; // Assuming this ID does not exist
//
//	    Mockito.when(repository.findById(userId)).thenReturn(Optional.empty());
//
//	    assertThrows(UserNotFound.class, () -> service.getUser(userId));
//	}
